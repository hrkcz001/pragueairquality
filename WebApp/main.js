...
var $author$project$Map$Point = F2(
	function (lng, lat) {
		return {lat: lat, lng: lng};
	});
var $author$project$Map$Region = F3(
	function (name, level, polygon) {
		return {level: level, name: name, polygon: polygon};
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Map$init = function (_v0) {
	return _Utils_Tuple2(
		{
			...
			regions: _List_fromArray(
				[
					A3(
					$author$project$Map$Region,
					'bubenec',
					3,
					_List_fromArray(
						[
							A2($author$project$Map$Point, 14.395732549581538, 50.10088651625327),
							A2($author$project$Map$Point, 14.395303396140633, 50.10650180167406),
							A2($author$project$Map$Point, 14.402599004660033, 50.10842846360924),
							A2($author$project$Map$Point, 14.406375554954394, 50.106171508991594),
							A2($author$project$Map$Point, 14.4042297877497, 50.10039101828883),
							A2($author$project$Map$Point, 14.395732549581538, 50.10088651625327)
						])),
					A3(
					$author$project$Map$Region,
					...
					_List_fromArray(
						[
							A2($author$project$Map$Point, 14.395299966467917, 50.100987503643125),
							A2($author$project$Map$Point, 14.39426999821444, 50.10720830661958),
							A2($author$project$Map$Point, 14.387661035205213, 50.10731840205523),
							A2($author$project$Map$Point, 14.385601098674641, 50.112877892249315),
							A2($author$project$Map$Point, 14.380022103918947, 50.112602685147465),
							A2($author$project$Map$Point, 14.378305490155213, 50.11051105948084),
							A2($author$project$Map$Point, 14.380022103918947, 50.10522654557647),
							A2($author$project$Map$Point, 14.384056146282518, 50.10434573657446),
							A2($author$project$Map$Point, 14.385343606605318, 50.10049200672319),
							A2($author$project$Map$Point, 14.395299966467917, 50.100987503643125)
						])),
					A3(
					$author$project$Map$Region,
					...
					_List_fromArray(
						[
							A2($author$project$Map$Point, 14.393545298533382, 50.11450640134473),
							A2($author$project$Map$Point, 14.386269881211774, 50.11314089880801),
							A2($author$project$Map$Point, 14.38792607377161, 50.10798198223506),
							A2($author$project$Map$Point, 14.394728293232902, 50.10775437017614),
							A2($author$project$Map$Point, 14.395319790574518, 50.10714739939041),
							A2($author$project$Map$Point, 14.402003710554453, 50.10896828866569),
							A2($author$project$Map$Point, 14.401589662418587, 50.11075117566244)
						]))
				]),
			...
			case 'SelectRegion':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selectedRegion: $elm$core$Maybe$Just(region)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var lngLat = msg.a.lngLat;
				...
				var test = A2(
					$elm$core$Debug$log,
					'pos',
					$elm$core$String$fromFloat(lngLat.lng) + (', ' + $elm$core$String$fromFloat(lngLat.lat)));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{features: renderedFeatures}),
...
var $author$project$Map$Hover = function (a) {
	return {$: 'Hover', a: a};
};
...
var $author$project$Map$colorFromLevel = function (level) {
	switch (level) {
		case 1:
			return A4($gampleman$elm_mapbox$Mapbox$Expression$rgba, 67, 146, 86, 255);
		case 2:
			return A4($gampleman$elm_mapbox$Mapbox$Expression$rgba, 190, 150, 30, 255);
		case 3:
			return A4($gampleman$elm_mapbox$Mapbox$Expression$rgba, 180, 40, 0, 255);
		default:
			return A4($gampleman$elm_mapbox$Mapbox$Expression$rgba, 0, 0, 0, 0);
	}
};
...
var $gampleman$elm_mapbox$Mapbox$Element$featureState = A2(
	...
	A2(
		...
		$gampleman$elm_mapbox$Mapbox$Element$MapboxAttr));
var $author$project$Map$hoveredFeatures = A2(
	$elm$core$Basics$composeR,
	$elm$core$List$map(
		function (feat) {
			return _Utils_Tuple2(
...
var $gampleman$elm_mapbox$Mapbox$Source$SourceOption = F2(
	function (a, b) {
		return {$: 'SourceOption', a: a, b: b};
	});
var $gampleman$elm_mapbox$Mapbox$Source$generateIds = A2(
	$gampleman$elm_mapbox$Mapbox$Source$SourceOption,
	'generateId',
	$elm$json$Json$Encode$bool(true));
...
var $author$project$Map$regionsToSource = function (regions) {
	var coords = function (region) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				function (p) {
					return '[' + ($elm$core$String$fromFloat(p.lng) + (', ' + ($elm$core$String$fromFloat(p.lat) + ']')));
				},
				region.polygon));
	};
	var regionJson = function (region) {
		return A2(
	...
	return A2(
		...
		function (region) {
			return A3(
				...
				region.name,
				_List_fromArray(
					[$gampleman$elm_mapbox$Mapbox$Source$generateIds]),
				regionJson(region));
		},
		regions);
};
...
var $gampleman$elm_mapbox$Mapbox$Layer$iconAllowOverlap = A2(
	$elm$core$Basics$composeR,
	$gampleman$elm_mapbox$Mapbox$Expression$encode,
	$gampleman$elm_mapbox$Mapbox$Layer$Layout('icon-allow-overlap'));
...
var $gampleman$elm_mapbox$Mapbox$Layer$iconIgnorePlacement = A2(
	$elm$core$Basics$composeR,
	$gampleman$elm_mapbox$Mapbox$Expression$encode,
	$gampleman$elm_mapbox$Mapbox$Layer$Layout('icon-ignore-placement'));
...
var $gampleman$elm_mapbox$Mapbox$Layer$iconSize = A2(
	$elm$core$Basics$composeR,
	$gampleman$elm_mapbox$Mapbox$Expression$encode,
	$gampleman$elm_mapbox$Mapbox$Layer$Layout('icon-size'));
...
var $author$project$Styles$Streets$styleLayers = _List_fromArray(
	[
		A2(
			...
			[
				...
				A2(
					...
					$gampleman$elm_mapbox$Mapbox$Expression$getProperty(
						$gampleman$elm_mapbox$Mapbox$Expression$str('class')))),
				$gampleman$elm_mapbox$Mapbox$Layer$fillColor(
				A4($gampleman$elm_mapbox$Mapbox$Expression$rgba, 181, 229, 158, 1)),
				$gampleman$elm_mapbox$Mapbox$Layer$fillOpacity(
				A3(
					$gampleman$elm_mapbox$Mapbox$Expression$interpolate,
					$gampleman$elm_mapbox$Mapbox$Expression$Exponential(1),
		...
		_List_fromArray(
			[
				$gampleman$elm_mapbox$Mapbox$Layer$sourceLayer('landuse'),
				$gampleman$elm_mapbox$Mapbox$Layer$minzoom(15),
				$gampleman$elm_mapbox$Mapbox$Layer$filter(
				A2(
					$gampleman$elm_mapbox$Mapbox$Expression$isEqual,
					$gampleman$elm_mapbox$Mapbox$Expression$str('pitch'),
				...
				A3(
					...
					_List_fromArray(
						[
							_Utils_Tuple2(
							14,
							$gampleman$elm_mapbox$Mapbox$Expression$float(0.12)),
							_Utils_Tuple2(
							16,
							$gampleman$elm_mapbox$Mapbox$Expression$float(0))
						]),
				...
				A3(
					...
					_List_fromArray(
						[
							_Utils_Tuple2(
							14,
							$gampleman$elm_mapbox$Mapbox$Expression$float(0.06)),
							_Utils_Tuple2(
							16,
							$gampleman$elm_mapbox$Mapbox$Expression$float(0))
						]),
		...
		_List_fromArray(
			[
				...
				$gampleman$elm_mapbox$Mapbox$Layer$minzoom(8),
				$gampleman$elm_mapbox$Mapbox$Layer$filter(
				A3(
		...
		_List_fromArray(
			[
				$gampleman$elm_mapbox$Mapbox$Layer$sourceLayer('waterway'),
				$gampleman$elm_mapbox$Mapbox$Layer$minzoom(13),
				$gampleman$elm_mapbox$Mapbox$Layer$filter(
				A3(
					$gampleman$elm_mapbox$Mapbox$Expression$matchesStr,
					_List_fromArray(
		...
		_List_fromArray(
			[
				...
				$gampleman$elm_mapbox$Mapbox$Layer$minzoom(11),
				$gampleman$elm_mapbox$Mapbox$Layer$filter(
				$gampleman$elm_mapbox$Mapbox$Expression$all(
					_List_fromArray(
						[
		...
		_List_fromArray(
			[
				$gampleman$elm_mapbox$Mapbox$Layer$sourceLayer('aeroway'),
				$gampleman$elm_mapbox$Mapbox$Layer$minzoom(9),
				$gampleman$elm_mapbox$Mapbox$Layer$filter(
				$gampleman$elm_mapbox$Mapbox$Expression$all(
					_List_fromArray(
						[
		...
		A3(
		$gampleman$elm_mapbox$Mapbox$Layer$line,
		'tunnel-service-link-track-case',
		'composite',
		_List_fromArray(
			[
				$gampleman$elm_mapbox$Mapbox$Layer$sourceLayer('road'),
		...
		_List_fromArray(
			[
				...
				A3(
					...
					$gampleman$elm_mapbox$Mapbox$Expression$zoom)),
				$gampleman$elm_mapbox$Mapbox$Layer$lineColor(
				A4($gampleman$elm_mapbox$Mapbox$Expression$rgba, 255, 191, 142, 1)),
				$gampleman$elm_mapbox$Mapbox$Layer$lineOpacity(
				$gampleman$elm_mapbox$Mapbox$Expression$float(1)),
				$gampleman$elm_mapbox$Mapbox$Layer$lineDasharray(
				$gampleman$elm_mapbox$Mapbox$Expression$floats(
								...
								[
									...
									_List_fromArray(
										[
											...
											_Utils_Tuple2('motorway_link', $gampleman$elm_mapbox$Mapbox$Expression$true),
				...
				A3(
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							17,
							$gampleman$elm_mapbox$Mapbox$Expression$float(4.6)),
							_Utils_Tuple2(
							18,
							$gampleman$elm_mapbox$Mapbox$Expression$float(7))
						]),
		...
		_List_fromArray(
			[
				...
				$gampleman$elm_mapbox$Mapbox$Expression$all(
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									_Utils_Tuple2('turning_circle', $gampleman$elm_mapbox$Mapbox$Expression$true),
									_Utils_Tuple2('turning_loop', $gampleman$elm_mapbox$Mapbox$Expression$true)
								]),
							$gampleman$elm_mapbox$Mapbox$Expression$false,
							$gampleman$elm_mapbox$Mapbox$Expression$getProperty(
								$gampleman$elm_mapbox$Mapbox$Expression$str('class')))
				...
				$gampleman$elm_mapbox$Mapbox$Layer$iconImage(
				$gampleman$elm_mapbox$Mapbox$Expression$str('turning-circle-outline')),
				$gampleman$elm_mapbox$Mapbox$Layer$iconSize(
				A3(
					$gampleman$elm_mapbox$Mapbox$Expression$interpolate,
					$gampleman$elm_mapbox$Mapbox$Expression$Exponential(1.5),
					_List_fromArray(
						[
							_Utils_Tuple2(
							14,
							$gampleman$elm_mapbox$Mapbox$Expression$float(0.122)),
							_Utils_Tuple2(
							18,
							$gampleman$elm_mapbox$Mapbox$Expression$float(0.969)),
							_Utils_Tuple2(
							20,
							$gampleman$elm_mapbox$Mapbox$Expression$float(1))
						]),
					$gampleman$elm_mapbox$Mapbox$Expression$zoom)),
				$gampleman$elm_mapbox$Mapbox$Layer$iconAllowOverlap($gampleman$elm_mapbox$Mapbox$Expression$true),
				$gampleman$elm_mapbox$Mapbox$Layer$iconIgnorePlacement($gampleman$elm_mapbox$Mapbox$Expression$true),
				$gampleman$elm_mapbox$Mapbox$Layer$iconPadding(
				$gampleman$elm_mapbox$Mapbox$Expression$float(0)),
		...
		_List_fromArray(
			[
				...
				A3(
					...
					$gampleman$elm_mapbox$Mapbox$Expression$zoom)),
				$gampleman$elm_mapbox$Mapbox$Layer$lineColor(
				A4($gampleman$elm_mapbox$Mapbox$Expression$rgba, 242, 208, 99, 1)),
				$gampleman$elm_mapbox$Mapbox$Layer$lineOpacity(
				$gampleman$elm_mapbox$Mapbox$Expression$float(1)),
				$gampleman$elm_mapbox$Mapbox$Layer$lineCap($gampleman$elm_mapbox$Mapbox$Expression$rounded),
				$gampleman$elm_mapbox$Mapbox$Layer$lineJoin($gampleman$elm_mapbox$Mapbox$Expression$rounded)
		...
		_List_fromArray(
			[
				...
				A3(
					...
					$gampleman$elm_mapbox$Mapbox$Expression$zoom)),
				$gampleman$elm_mapbox$Mapbox$Layer$lineColor(
				A4($gampleman$elm_mapbox$Mapbox$Expression$rgba, 255, 162, 91, 1)),
				$gampleman$elm_mapbox$Mapbox$Layer$lineOpacity(
				$gampleman$elm_mapbox$Mapbox$Expression$float(1)),
				$gampleman$elm_mapbox$Mapbox$Layer$lineCap($gampleman$elm_mapbox$Mapbox$Expression$rounded),
				$gampleman$elm_mapbox$Mapbox$Layer$lineJoin($gampleman$elm_mapbox$Mapbox$Expression$rounded)
		...
		_List_fromArray(
			[
				...
				$gampleman$elm_mapbox$Mapbox$Layer$iconImage(
				$gampleman$elm_mapbox$Mapbox$Expression$str('turning-circle')),
				$gampleman$elm_mapbox$Mapbox$Layer$iconSize(
				A3(
					$gampleman$elm_mapbox$Mapbox$Expression$interpolate,
					$gampleman$elm_mapbox$Mapbox$Expression$Exponential(1.5),
					_List_fromArray(
						[
							_Utils_Tuple2(
							14,
							$gampleman$elm_mapbox$Mapbox$Expression$float(0.095)),
							_Utils_Tuple2(
							18,
							$gampleman$elm_mapbox$Mapbox$Expression$float(1))
						]),
		...
		_List_fromArray(
			[
				...
				$gampleman$elm_mapbox$Mapbox$Layer$textColor(
				A4($gampleman$elm_mapbox$Mapbox$Expression$rgba, 17, 17, 17, 1)),
		...
		_List_fromArray(
			[
				$gampleman$elm_mapbox$Mapbox$Layer$sourceLayer('place_label'),
				$gampleman$elm_mapbox$Mapbox$Layer$minzoom(6),
				$gampleman$elm_mapbox$Mapbox$Layer$maxzoom(15),
				$gampleman$elm_mapbox$Mapbox$Layer$filter(
				A2(
					$gampleman$elm_mapbox$Mapbox$Expression$isEqual,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'width', '77vw')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$gampleman$elm_mapbox$Mapbox$Element$onMouseMove($author$project$Map$Hover),
						$gampleman$elm_mapbox$Mapbox$Element$onClick($author$project$Map$Click),
						...
						A2(
							...
							model.regions)),
						$author$project$Map$hoveredFeatures(model.features)
					]),
				$gampleman$elm_mapbox$Mapbox$Style$Style(
					{
						layers: _Utils_ap(
							$author$project$Styles$Streets$styleLayers,
							A2(
								$elm$core$List$map,
								function (region) {
									return A3(
										...
										_List_fromArray(
											[
												$gampleman$elm_mapbox$Mapbox$Layer$fillOutlineColor(
												A4($gampleman$elm_mapbox$Mapbox$Expression$rgba, 0, 0, 0, 255)),
												$gampleman$elm_mapbox$Mapbox$Layer$fillColor(
												$author$project$Map$colorFromLevel(region.level)),
												$gampleman$elm_mapbox$Mapbox$Layer$fillOpacity(
												A3(
						...
						misc: _List_fromArray(
							[
								...
								A2($gampleman$elm_mapbox$LngLat$LngLat, 14.414268304014513, 50.09159887774365)),
...
var $author$project$Map$main = $elm$browser$Browser$element(
	{
		init: $author$project$Map$init,
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$Map$update,
		view: $author$project$Map$view
	});

...
var $author$project$Map$GotRegions = function (a) {
...
var $author$project$Map$lngLatDecoder = A3(
...
var $author$project$Map$regionDecoder = A4(
	...
	A2(
		...
		_List_fromArray(
			['polygon']),
		$elm$json$Json$Decode$list($author$project$Map$lngLatDecoder)));
...
var $author$project$Map$getRegions = $elm$http$Http$request(
	{
		body: $elm$http$Http$emptyBody,
		expect: A2(
			$elm$http$Http$expectJson,
			$author$project$Map$GotRegions,
			$elm$json$Json$Decode$list($author$project$Map$regionDecoder)),
		headers: _List_Nil,
		method: 'GET',
...
var $author$project$Map$init = function (_v0) {
	return _Utils_Tuple2(
		{features: _List_Nil, regions: _List_Nil},
		$author$project$Map$getRegions);
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$gampleman$elm_mapbox$Mapbox$Element$id('paq-map'),
				...
				$gampleman$elm_mapbox$Mapbox$Style$Style(
					{
						...
						sources: A2(
							...
							$author$project$Map$regionsToSources(model.regions)),
